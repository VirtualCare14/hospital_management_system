...
const ROUTE_HEADER_MAP = [
  ...
  { path: '/doctor/consultation/', title: 'Clinical Consultation', subtitle: 'Examine patient, record vitals, chief complaints, symptoms, diagnosis, and advice.' },
  ...
  { path: '/admin/room-settings', title: 'IPD & Room Management', subtitle: 'Configure wards, room types, bed capacities, and daily rate structures.' },
